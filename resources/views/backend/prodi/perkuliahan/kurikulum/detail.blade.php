...
<div class="ibox float-e-margins">
    ...
    <div class="ibox-content">
        <div class="row">
            <div class="col-lg-12">
                <a class="btn btn-primary pull-right" href="{{route('admin-prodi.kurikulum')}}"><i class="fa-solid fa-list"></i> <span>Daftar Kurikulum</span></a>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <input type="name" class="form-control" disabled value="{{ !empty($detail_kurikulum[0]->nama_program_studi) ? $detail_kurikulum[0]->nama_program_studi :"-" }}">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    <label>Mulai Berlaku <span style="color: red">*</span></label>
                    <input type="name" class="form-control" disabled value="{{ !empty($detail_kurikulum[0]->semester_mulai_berlaku) ? $detail_kurikulum[0]->semester_mulai_berlaku :"-" }}">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    <label>Jumlah Bobot Mata Kuliah Wajib <span style="color: red">*</span></label>
                    <input type="name" class="form-control" disabled value="{{ !empty($detail_kurikulum[0]->jumlah_sks_wajib) ? $detail_kurikulum[0]->jumlah_sks_wajib :"-" }}">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    <label>Jumlah Bobot Mata Kuliah Pilihan <span style="color: red">*</span></label>
                    <input type="name" class="form-control" disabled value="{{ !empty($detail_kurikulum[0]->jumlah_sks_pilihan) ? $detail_kurikulum[0]->jumlah_sks_pilihan :"-" }}">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    <label>Jumlah SKS</label>
                    <input type="name" class="form-control" disabled value="{{ !empty($detail_kurikulum[0]->jumlah_sks_lulus) ? $detail_kurikulum[0]->jumlah_sks_lulus :"-" }}">
                </div>
            </div>
        </div>
    </div><br>
