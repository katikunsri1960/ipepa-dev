        ...
        <div class="ibox-content p-md">
            <div class="row">
                <form method="get" id="filter-form">
                    ...
                    <div class="col-md-2">
                        <a href="{{route('admin-prodi.aktivitas-kuliah-mahasiswa')}}" class="btn btn-warning btn-block" id="reset-filter">Reset Filter</a>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#table-akm').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin-prodi.akm-data') }}",
                    data: function (d) {
                        d.prodi = $('#prodi').val();
                ...
                columns: [
                    ...
                    {data: 'nim', name: 'nim', searchable: false,
                            "render": function ( data, type, row, meta ) {
                                var link = '<a href="{{route("admin-prodi.detail-aktivitas-kuliah-mahasiswa", ["id" => ":id", "semester" => ":sem"])}}">:data</a>';
