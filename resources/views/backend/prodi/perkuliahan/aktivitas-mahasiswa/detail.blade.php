        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <input type="name" class="form-control" disabled value="{{ !empty($detail[0]->sk_tugas) ? $detail[0]->sk_tugas :"-"}}">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    <label>Tanggal SK Tugas</label>
                    <input type="name" class="form-control" disabled value="{{ !empty($detail[0]->tanggal_sk_tugas) ? $detail[0]->tanggal_sk_tugas :"-"}}">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    <label>Jenis Aktivitas <span style="color: red">*</span></label>
                    <input type="name" class="form-control" disabled value="{{ !empty($detail[0]->nama_jenis_aktivitas) ? $detail[0]->nama_jenis_aktivitas :"-"}}">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    <label>Jenis Anggota</label>
                    <input type="name" class="form-control" disabled value="{{ !empty($detail[0]->nama_jenis_anggota) ? $detail[0]->nama_jenis_anggota :"-"}}">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    <label>Judul <span style="color: red">*</span></label>
                    <input type="text" class="form-control" disabled value="{{ !empty($detail[0]->judul) ? $detail[0]->judul :"-"}}">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    <label>Keterangan</label>
                    <input type="text" class="form-control" disabled value="{{ !empty($detail[0]->keterangan) ? $detail[0]->keterangan :"-"}}">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    <label>Lokasi</label>
                    <input type="name" class="form-control" disabled value="{{ !empty($detail[0]->lokasi) ? $detail[0]->lokasi :"-"}}">
                </div>
            </div>
        </div>
    </div>
