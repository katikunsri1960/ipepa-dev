        ...
        <div class="ibox-content p-md">
            <div class="row">
                <form method="get" id="filter-form">
                    ...
                    <div class="col-md-2">
                        <a href="{{route('admin-prodi.kampus-merdeka')}}" class="btn btn-warning btn-block" id="reset-filter">Reset Filter</a>
                    </div><br><br><hr>
                </form>
            </div>
            <div class="pt-2">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#table-matkul').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin-prodi.merdeka-data') }}",
                    data: function (d) {
                        d.prodi = $('#prodi').val();
                    }
                },
                ...
                columns: [
                    ...
                    {data: 'nama_prodi', name: 'nama_prodi', searchable: true,
                            "render": function ( data, type, row, meta ) {
                                var link = '<a href="{{route("admin-prodi.detail-kampus-merdeka", ["id" => ":id"])}}">:data</a>';
