        ...
        <div class="row">
            <form method="get">
                <div class="col-md-2">
                    ...
                    <a href="{{route('admin-prodi.mahasiswa-lulus-do')}}" class="btn btn-warning btn-block" id="reset-filter">Reset Filter</a>
                </div><br><br><hr>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#table-akm').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin-prodi.lulus-do-data') }}",
                    data: function (d) {
                        d.prodi = $('#prodi').val();
                ...
                columns: [
                    ...
                    {data: 'nim', name: 'nim', searchable: true,
                            "render": function ( data, type, row, meta ) {
                                var link = '<a href="{{route("admin-prodi.detail-mahasiswa-lulus-do", ["id" => ":id", "tahun" => ":ang"])}}">:data</a>';
