...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#mahasiswa-data').on('submit', function (e) {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{route('admin-prodi.mahasiswa-asing.data')}}",
                    data: {
                        semester: semester,
                    },
                    success: function (response) {
                        ...
                        if (data.length > 0) {
                            ...
                            $('<th rowspan="2">').addClass('text-center align-middle').text('No').appendTo(headerRow);
                            $('<th rowspan="2">').addClass('text-center align-middle').text('Tahun Akademik').appendTo(headerRow);
                            $('<th rowspan="2">').addClass('text-center align-middle').text('Semester').appendTo(headerRow);
                            $('<th rowspan="2">').addClass('text-center align-middle').text('Jumlah Mahasiswa Aktif').appendTo(headerRow);
                            $('<th rowspan="2">').addClass('text-center align-middle').text('Jumlah Mahasiswa Aktif Penuh Waktu (Full-time)').appendTo(headerRow);
                            $('<th rowspan="2">').addClass('text-center align-middle').text('Jumlah Mahasiswa Aktif Paruh Waktu (Part-time)').appendTo(headerRow);
                            ...
                            data.forEach(function (mahasiswa, index) {
                                ...
                                $('<td rowspan="2">').addClass('align-middle text-center').css('vertical-align', 'middle').text(mahasiswa.tahun_akademik).appendTo(row);
                                ...
                                $('<td>').addClass('align-middle text-center').text(mahasiswa.data['ganjil']['asing_penuh']).appendTo(row);
                                $('<td>').addClass('align-middle text-center').text(mahasiswa.data['ganjil']['asing_paruh']).appendTo(row);
                                ...
                                $('<td>').addClass('align-middle text-center').text(mahasiswa.data['genap']['asing_penuh']).appendTo(row2);
                                $('<td>').addClass('align-middle text-center').text(mahasiswa.data['genap']['asing_paruh']).appendTo(row2);
