    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="widget lazur-bg p-xl">
                ...
                <hr>
                <h4>Notes :</h4>
                <p><i class="fa fa-hand-o-right"></i> Data yang ditampilkan pada halaman ini merupakan data dari Neo Feeder PDDIKTI<br><i class="fa fa-hand-o-right"></i> Last Sync Table ({{$jumlah_data_sync[0]['updated_at']}} - {{$jumlah_data_sync[0]['table_name']}})</p>
            </div>
        </div>
    </div>
    <div class="row">
