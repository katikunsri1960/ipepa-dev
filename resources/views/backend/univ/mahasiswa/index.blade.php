                                                ...
                                                <select name="angkatan[]" id="angkatan"
                                                    ...
                                                    @foreach ($angkatan as $ang)
                                                        <option value="{{ $ang->angkatan }}"
                                                            @if ($val->angkatan && in_array($ang->id_periode, $val->angkatan)) selected @endif>
                                                            {{ $ang->angkatan }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <select name="status[]" id="status"
                                                    ...
                                                    @foreach ($status as $s)
                                                        <option value="{{ $s->nama_status_mahasiswa }}"
                                                            @if ($val->status && in_array($s->nama_status_mahasiswa, $val->status)) selected @endif>
                    ...
                    <tbody>
                        @foreach ($mahasiswa as $m => $data)
                            <tr>
                                ...
                                <td><a
                                        href="{{ route('admin-univ.detail-mahasiswa', ['id' => $data->id_mahasiswa]) }}">{{ $data->nama_mahasiswa }}</a>
                                </td>
