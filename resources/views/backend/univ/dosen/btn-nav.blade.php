<div class="ibox-content">
    ...
    <a href="{{route('admin-univ.pembimbing-aktivitas-mahasiswa', ['id' => $dosen->id_dosen])}}" class="btn @if (request()->routeIs('admin-univ.pembimbing-aktivitas-mahasiswa')) btn-primary @else btn-default @endif">
        Pembimbing Aktivitas Mahasiswa</a>
    <a href="{{route('admin-univ.penguji-aktivitas-mahasiswa', ['id' => $dosen->id_dosen])}}" class="btn @if (request()->routeIs('admin-univ.penguji-aktivitas-mahasiswa')) btn-primary @else btn-default @endif">
