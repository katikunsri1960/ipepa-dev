                ...
                <div class="col-lg-12">
                    <div class="widget yellow-bg no-padding">
                        <div class="p-m">
                            ...
                            <h5>Mencatat penugasan dosen setiap tahunnya, Data penugasan hanya dapat di ubah pada laman <a
                                    href="http://pddikti.kemendikbud.go.id">http://pddikti.kemendikbud.go.id</a></h5>
                        </div>
                    </div>
                </div>
            </div>
