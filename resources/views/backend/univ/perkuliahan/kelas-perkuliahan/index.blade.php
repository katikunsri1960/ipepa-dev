            ...
            <div class="pt-2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td  class="text-left"> <a href="{{route('admin-univ.detail-kelas-perkuliahan', ['id' => $data->id_matkul, 'kelas_kuliah' => $data->nama_kelas_kuliah, 'semester' => $data->id_semester])}}"
                        {{-- <td  class="text-left"> <a href="{{route('admin-univ.detail-kelas-perkuliahan', ['id' => $data->id_matkul, 'semester' => $data->id_semester])}}" --}}
