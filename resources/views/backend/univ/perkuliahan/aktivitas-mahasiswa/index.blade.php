        ...
        <div class="ibox-content p-md">
            <div class="row">
                <form method="get" id="filter-form">
                    ...
                    <div class="col-md-2">
                        <a href="{{route('admin-univ.aktivitas-mahasiswa')}}" class="btn btn-warning btn-block" id="reset-filter">Reset Filter</a>
                    </div>
                ...
                columns: [
                    ...
                    {data: 'nama_prodi', name: 'nama_prodi', searchable: false,
                            "render": function ( data, type, row, meta ) {
                                var link = '<a href="{{route("admin-univ.detail-aktivitas-mahasiswa", ["id" => ":id"])}}">:data</a>';
