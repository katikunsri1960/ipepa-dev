...
class PemantauanController extends Controller
{
    public function index(Request $req)
    {
        ...
        $mahasiswa = ListMahasiswa::leftJoin('pd_feeder_list_mahasiswa_lulus_do as lo', 'pd_feeder_list_mahasiswa.id_registrasi_mahasiswa',  'lo.id_registrasi_mahasiswa')
        ...
        // $mahasiswa = ListMahasiswa::join('pd_feeder_list_mahasiswa_lulus_do as lo', function($join) {
        //                     $join->on('pd_feeder_list_mahasiswa.id_registrasi_mahasiswa', '=', 'lo.id_registrasi_mahasiswa')
        //                          ->select('pd_feeder_list_mahasiswa.id_registrasi_mahasiswa as id_rm', 'pd_feeder_list_mahasiswa.nama_status_mahasiswa as nama_status',
        //                                     'pd_feeder_list_mahasiswa.id_periode as angkatan', 'lo.tgl_masuk_sp as tgl_masuk', 'lo.tgl_sk_yudisium')
    ...
    public function dev(Request $req)
    {
        $mahasiswa = ListMahasiswa::leftJoin('pd_feeder_list_mahasiswa_lulus_do as lo', 'pd_feeder_list_mahasiswa.id_registrasi_mahasiswa',  'lo.id_registrasi_mahasiswa')
                                    ->select('pd_feeder_list_mahasiswa.id_registrasi_mahasiswa as id_rm', 'pd_feeder_list_mahasiswa.nama_status_mahasiswa as nama_status',
                                            'pd_feeder_list_mahasiswa.id_periode as angkatan', 'lo.tgl_masuk_sp as tgl_masuk', 'lo.tgl_sk_yudisium')->get();
