...
class PeriodePerkuliahanController extends Controller
{
    public function index(Request $req)
    {
        ...
        ->select('id_semester', 'pd_feeder_list_periode_perkuliahan.id_prodi', 'pd_feeder_list_periode_perkuliahan.nama_program_studi', 'nama_semester', 'jumlah_target_mahasiswa_baru', 'tanggal_awal_perkuliahan','tanggal_akhir_perkuliahan','pd_feeder_program_studi.status')
        ->paginate(20);

        return view('backend.univ.pelengkap.periode-perkuliahan.index', compact('periode_kuliah','prodi','semester','val'));
    }
