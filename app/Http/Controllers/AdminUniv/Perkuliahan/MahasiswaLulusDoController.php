...
class MahasiswaLulusDoController extends Controller
{
    public function index(Request $req)
    {
        ...
        return view('backend.univ.perkuliahan.mahasiswa-lulus-do.index', compact('mahasiswa_lulus_do','prodi','angkatan','jenis_keluar','tahun_keluar','tahun_keluar_aktif','valPaginate','paginate','val'));
    }
