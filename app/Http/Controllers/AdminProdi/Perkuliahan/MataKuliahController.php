...
class MataKuliahController extends Controller
{
    public function index(Request $req)
    {
        ...
        return view('backend.prodi.perkuliahan.mata-kuliah.index', compact('mata_kuliah','prodi', 'jenis_matkul','paginate', 'valPaginate', 'val'));
    }
    ...
    public function detail_matkul($id)
    {
        ...
        // dd($pembelajaran);
        return view('backend.prodi.perkuliahan.mata-kuliah.detail', compact('detail_matkul','pembelajaran', 'evaluasi'));
    }
