...
class SkalaNilaiController extends Controller
{
    public function index(Request $req)
    {
        ...
        ->select('id_bobot_nilai', 'id_prodi', 'nama_program_studi', 'nilai_huruf', 'nilai_indeks', 'bobot_minimum','bobot_maksimum', 'tanggal_mulai_efektif','tanggal_akhir_efektif')->where('pd_feeder_list_skala_nilai_prodi.id_prodi',$prodiId)
        ->paginate(20);

        return view('backend.prodi.pelengkap.skala-nilai.index', compact('skala_nilai','prodi','val'));
    }
