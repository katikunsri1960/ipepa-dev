...
class ExportAktivitasMengajarDosen implements FromCollection, WithHeadings
{
    ...
    public function collection()
    {
        ...
        return $data->select('nidn','pd_feeder_aktivitas_mengajar_dosen.nama_dosen')
                    ...
                    ->addSelect(DB::raw('(SELECT sks_substansi_total FROM pd_feeder_dosen_pengajar_kelas_kuliah WHERE pd_feeder_dosen_pengajar_kelas_kuliah.id_dosen=pd_feeder_aktivitas_mengajar_dosen.id_dosen AND pd_feeder_dosen_pengajar_kelas_kuliah.id_kelas_kuliah=pd_feeder_aktivitas_mengajar_dosen.id_kelas AND pd_feeder_dosen_pengajar_kelas_kuliah.id_semester=pd_feeder_aktivitas_mengajar_dosen.id_periode AND pd_feeder_dosen_pengajar_kelas_kuliah.id_prodi=pd_feeder_aktivitas_mengajar_dosen.id_prodi) AS bobot_ajar'))
                    ->addSelect(DB::raw('(SELECT rencana_minggu_pertemuan FROM pd_feeder_dosen_pengajar_kelas_kuliah WHERE pd_feeder_dosen_pengajar_kelas_kuliah.id_dosen=pd_feeder_aktivitas_mengajar_dosen.id_dosen AND pd_feeder_dosen_pengajar_kelas_kuliah.id_kelas_kuliah=pd_feeder_aktivitas_mengajar_dosen.id_kelas AND pd_feeder_dosen_pengajar_kelas_kuliah.id_semester=pd_feeder_aktivitas_mengajar_dosen.id_periode AND pd_feeder_dosen_pengajar_kelas_kuliah.id_prodi=pd_feeder_aktivitas_mengajar_dosen.id_prodi) AS rencana_minggu_pertemuan'))
                    ->addSelect(DB::raw('(SELECT realisasi_minggu_pertemuan FROM pd_feeder_dosen_pengajar_kelas_kuliah WHERE pd_feeder_dosen_pengajar_kelas_kuliah.id_dosen=pd_feeder_aktivitas_mengajar_dosen.id_dosen AND pd_feeder_dosen_pengajar_kelas_kuliah.id_kelas_kuliah=pd_feeder_aktivitas_mengajar_dosen.id_kelas AND pd_feeder_dosen_pengajar_kelas_kuliah.id_semester=pd_feeder_aktivitas_mengajar_dosen.id_periode AND pd_feeder_dosen_pengajar_kelas_kuliah.id_prodi=pd_feeder_aktivitas_mengajar_dosen.id_prodi) AS realisasi_minggu_pertemuan'))
                    ->get();
    }
