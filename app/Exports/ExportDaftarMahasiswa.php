...
class ExportDaftarMahasiswa implements FromCollection, WithHeadings
{
    ...
    {
        $data = ListMahasiswa::leftJoin('pd_feeder_biodata_mahasiswa', 'pd_feeder_biodata_mahasiswa.id_mahasiswa', 'pd_feeder_list_mahasiswa.id_mahasiswa')->leftJoin('pd_feeder_list_riwayat_pendidikan_mahasiswa','pd_feeder_list_riwayat_pendidikan_mahasiswa.id_mahasiswa','pd_feeder_list_mahasiswa.id_mahasiswa')->leftJoin('pd_feeder_semester','pd_feeder_semester.id_semester','pd_feeder_list_mahasiswa.id_periode');
